...
Slaser.innerText = "Rapid Update [Num9]:"
Sfps.innerText = "Mine Decluster [M]:"
Sodhack.innerText = "OD Hack [End]:"


Slaser.style.bottom = "45%"
Sfps.style.bottom = "25%"
Sodhack.style.bottom = "5%"
...
State1.style.bottom = "45%"
State2.style.bottom = "25%"
State3.style.bottom = "5%"
...
document.addEventListener('keydown', (e) => { if (e.keyCode === 105 && game.isNotOpenChat()){
s1p+=1
if(s1p%2==1){
State1.innerText = "ON"
